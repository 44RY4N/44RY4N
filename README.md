...
* Built a **modular REST API** following clean **MVC architecture**.
* Structured controllers, routes, and services for scalability.
* Focused on readable, maintainable backend code.
* Designed with future database integration and expansion in mind.
...
* Case studies explaining architecture & decision-making
* Exploring **React**, **React Three Fiber**, and backend scalability
...
* Clean architecture patterns for full-stack apps
...
> *“Code is where creativity meets logic — I build with both.”*
